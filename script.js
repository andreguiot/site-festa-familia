        ...
        "2": {
                "matutino": {
                        ...
                        "events": [
                                ...
                                { "time": "8h40", "edFisica": "121M", "maker": "122M" },
                                { "time": "9h00", "exprCult": "121 e 122M" }
                        ]
                },
                "vespertino": {
                        "date": "25/09 (QUI) - TURNO VESPERTINO",
                        "events": [
                                { "time": "16h20", "maker": "125T", "mEspiritual": "123, 124T", "exprCult": "126T" },
                                { "time": "16h40", "edFisica": "123T", "maker": "124T", "mEspiritual": "125, 126T" },
                                { "time": "17h00", "edFisica": "125T", "maker": "126T", "exprCult": "123, 124T" },
                                { "time": "17h20", "edFisica": "124 e 126T", "maker": "123T", "exprCult": "125T" }
                        ]
                }
        },
        "3": {
                "matutino": {
                        ...
                        "events": [
                                ...
                                { "time": "8h40", "edFisica": "131M", "maker": "132M" },
                                { "time": "9h00", "exprCult": "131 e 132M" }
                        ]
                },
                "vespertino": {
                        "date": "23/09 (TER) - TURNO VESPERTINO",
                        "events": [
                                { "time": "16h20", "edFisica": "136", "maker": "135, 137T", "mEspiritual": "133, 134T" },
                                { "time": "16h40", "edFisica": "134", "maker": "133", "mEspiritual": "135, 136T" },
                                { "time": "17h00", "edFisica": "133", "maker": "134", "exprCult": "135, 136T" },
                                { "time": "17h20", "edFisica": "135", "maker": "136", "exprCult": "133, 134T" }
                        ]
                }
        },
        "4": {
                "matutino": {
                        ...
                        "events": [
                                { "time": "8h00", "mEspiritual": "141 e 142M" },
                                { "time": "8h20", "edFisica": "141M", "maker": "142M" },
                                { "time": "8h40", "edFisica": "142M", "maker": "141M" },
                                { "time": "9h00", "mEspiritual": "141M", "exprCult": "142M" }
                        ]
                },
                "vespertino": {
                        "date": "24/09 (QUA) - TURNO VESPERTINO",
                        "events": [
                                { "time": "16h20", "edFisica": "146", "maker": "145", "mEspiritual": "143, 144T" },
                                { "time": "16h40", "edFisica": "143", "maker": "144", "mEspiritual": "145, 146T" },
                                { "time": "17h00", "edFisica": "145", "maker": "146", "exprCult": "143, 144T" },
                                { "time": "17h20", "edFisica": "144", "maker": "143", "exprCult": "145, 146T" },
                                { "time": "16h20", "maker": "137T", "mEspiritual": "147 e 148T" },
                                { "time": "16h40", "edFisica": "147T", "maker": "148T", "mEspiritual": "137T" },
                                { "time": "17h00", "edFisica": "148T", "maker": "147T", "exprCult": "137T" },
                                { "time": "17h20", "edFisica": "137T", "exprCult": "147 e 148T" }
                        ]
                }
        },
        "5": {
                "matutino": {
                        ...
                        "events": [
                                { "time": "8h00", "mEspiritual": "151, 152, 153M" },
                                { "time": "8h20", "edFisica": "151M", "maker": "152M", "exprCult": "153M" },
                                { "time": "8h40", "edFisica": "152 e 153M", "maker": "151M" },
                                { "time": "9h00", "maker": "153M", "exprCult": "152 e 151M" }
                        ]
                },
                "vespertino": {
                        "date": "22/09 (SEG) - TURNO VESPERTINO",
                        "events": [
                                { "time": "16h20", "edFisica": "157", "maker": "156", "mEspiritual": "154, 155T" },
                                { "time": "16h40", "edFisica": "155", "maker": "154", "mEspiritual": "156, 157T" },
                                { "time": "17h00", "edFisica": "156", "maker": "157", "exprCult": "154, 155T" },
                                { "time": "17h20", "edFisica": "154", "maker": "155", "exprCult": "156, 157T" }
                        ]
                }
        }
    };
